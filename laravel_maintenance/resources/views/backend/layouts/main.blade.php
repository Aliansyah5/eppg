...
<body class="nav-md">
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="<?=url('/backend')?>" class="site_title"> <span>&nbsp;<img
                                    src="<?=url('img/ppg.png');?>" ; style="max-width:120px;"></span></a>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    <li><a href="<?=url('backend/logout');?>"><i class="fa fa-sign-out pull-right"></i>
                                            Log Out</a></li>
                                </ul>
                            </li>
                        </ul>
    ...
    <script src="<?=url('vendors/select2/select2.js');?>"></script>
    {{-- ChartScript --}}
