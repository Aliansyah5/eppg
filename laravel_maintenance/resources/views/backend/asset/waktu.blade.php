			...
			<div class="x_panel">
				<div class="x_content">
					...
					{{ Form::open(['url' => $url, 'method' => $method,'class' => 'form-horizontal form-label-left']) }}
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3 col-xs-12">Kategori Asset<span class="required"></span></label>
                            <div class="col-sm-3 col-xs-12">
                                ...
                                *Pilih kategori asset berdasarkan jenis maintenance <br/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="x_title">
                        <h2>{{$komponen->count()}} Sparepart Maintenance </h2>
                            <div class="clearfix"></div>
                        </div>
                        @if ($komponen->count() != 0)
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-xs-12">Stok Gudang<span class="required"></span></label>
                                <div class="col-sm-3 col-xs-12">
                                    <input type="text" min="0" readonly name="mainthour" required="required" class="form-control" value="{{ $komp->mspart['Stok'] == NULL ? 0 : $komp->mspart['Stok']  }}"" autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-xs-12">Satuan<span class="required"></span></label>
                                <div class="col-sm-3 col-xs-12">
                                <input type="text" min="0" readonly name="satuan" required="required" class="form-control" value="{{$komp->mspart['Sat']}}" autofocus>
                                </div>
                            </div>


                            <div class="form-group">
                                <label class="control-label col-sm-3 col-xs-12">Life Time<span class="required"></span></label>
                                <div class="col-sm-3 col-xs-12">
