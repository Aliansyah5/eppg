...
<div class="row">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-1 col-sm-1 col-xs-2">
            <input type="number" name="ayat_akhir" value="<?=$ayat_akhir;?>"  min="0" id="ayat_akhir" class="form-control" width="300" disabled>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <select class=" form-control select_2"   name="pengajar_quran" disabled >
                ...
                <option value="{{$pemateri->id}}" {{ $pengajar_quran == $pemateri->id ? 'selected' : '' }} >
    ...
    <div class="form-group row">
        ...
        <label class="control-label col-md-1 col-sm-1 " style="text-align: center">s/d</label>
        <div class="col-md-1 col-sm-1 col-xs-2">
            <input type="number" name="hal_akhir" value="<?=$hal_akhir;?>"  min="0" id="hal_akhir" class="form-control" width="300" disabled>
        </div>
    </div>
    <div class="form-group row">
...
$('.dataTablePerempuan').dataTable({
    ...
    $( document ).ready(function() {
        console.log('ok');
        $('.dataTableLakiLaki, .dataTablePerempuan ').find('input[type="text"]').attr('disabled','disabled');
        $('.dataTableLakiLaki input[type=text]').attr("disabled",true);
    });

    $(".dataTableLakiLaki, .dataTablePerempuan ").on("click",".status", function () {
    ...
    $(".dataTableLakiLaki, .dataTablePerempuan ").on("click",".keterangan", function () {
