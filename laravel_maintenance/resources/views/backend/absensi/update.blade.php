...
<div class="row">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <select class=" form-control select_2"   name="pengajar_quran"  >
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <select class=" form-control select_2"   name="pengajar_hadist"  >
                <option value="">(Pilih Pengajar)</option>
                @foreach($pemateris as $pemateri)
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <select class=" form-control select_2"   name="penasehat"  >
